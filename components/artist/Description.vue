...
.description-border-right {
    ...
    height: 380px;
    width: 300px;
    shape-outside: polygon(48.32% 83.42%, 50.63% 66.6%, 49.49% 57.43%, 46.51% 48.95%, 42% 37.42%, 36.47% 26.71%, 23.48% 11.27%, 2.44% 1.55%, 101% 0.73%, 98.33% 97.77%, 34.43% 99%, 41.93% 94.15%);
    -webkit-shape-outside: polygon(48.32% 83.42%, 50.63% 66.6%, 49.49% 57.43%, 46.51% 48.95%, 42% 37.42%, 36.47% 26.71%, 23.48% 11.27%, 2.44% 1.55%, 101% 0.73%, 98.33% 97.77%, 34.43% 99%, 41.93% 94.15%);
}
